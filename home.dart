...
class _SignUpFormState extends State<SignUpForm> {
  ...
  final _PosswordTextController = TextEditingController();

  double _formProgress = 0;

  void _updateFormProgress() {
    var progress = 0.0;
    final controllers = [_MobileNumberTextController, _PosswordTextController];
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: TextFormField(
              controller: _PosswordTextController,
              decoration: const InputDecoration(hintText: 'Пороль'),
            ),
          ),
          TextButton(
            style: ButtonStyle(
